...
From these results one can observe that floods have a value of total property damages with a magnitude higher than the second highest, tornado. Let's observe these results in plot, where we get a clearer view of the extent of crop damages as well. This can be seen in Figure 2.
